...
import com.unir.calculatorH2.model.db.AdditionNumber;
...
public class AdditionDto {
    ...
    public AdditionDto(AdditionResult result){
        this.id = result.getId();
        this.result = result.getResult();
        this.numbers = result.getNumbers().stream().map(AdditionNumber::getNumber).toList();
    }
}
